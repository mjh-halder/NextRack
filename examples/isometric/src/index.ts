...
const designNameEl = document.getElementById('design-name') as HTMLDivElement;
...
// Left inset = palette width (160px) + breathing room (20px).
// Content is shifted right by this amount so it starts clear of the sidebar.
const SIDEBAR_INSET = 180;
