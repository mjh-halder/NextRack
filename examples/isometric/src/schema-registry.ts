...
const BUILT_IN_TYPES: DataTypeDefinition[] = [
    ...
    },
    {
        ...
        fields: [
            ...
            { key: 'baseShape',              label: 'Base Shape',        type: 'select',  system: true, options: ['rectangle', 'circle', 'tube', 'pipe', 'duct', 'channel', 'octagon', 'hexahedron', 'custom'] },
    ...
    },
    {
        ...
        kind: 'option-set',
        fields: [
            { key: 'rectangle',     label: 'Rectangle',     type: 'text', system: true },
            { key: 'circle',   label: 'Circle',   type: 'text', system: true },
